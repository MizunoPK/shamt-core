...
```
/pe1-define {slug} [--tracker={ado|github|local}]
```
...
<!-- Managed by Shamt — do not edit. Regenerate from shamt-core/host/templates/claude/commands/pe1-define.md. -->
