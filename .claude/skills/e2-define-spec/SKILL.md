...
5. **Flesh out** — record the agreed approach. Required sections: Review Prevention Gates, Database Schema Changes (when applicable), Test Strategy (when `testing: "enabled"`), Key Design Decisions.
